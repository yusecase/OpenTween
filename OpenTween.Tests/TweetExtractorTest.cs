...
namespace OpenTween
{
    public class TweetExtractorTest
    {
        ...
        public void ExtractEmojiEntities_Test()
        {
            ...
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/2728.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_SurrogatePairTest()
        {
            ...
            Assert.Equal("🍚", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f35a.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_VariationSelector_EmojiStyleTest()
        {
            ...
            Assert.Equal("©", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/a9.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_VariationSelector_UnnecessaryEmojiStyleTest()
        {
            ...
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f363.png", entities[0].Url);
        ...
        public void ExtractEmojiEntities_CombiningCharacterTest()
        {
            ...
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/23-20e3.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_Unicode10Test()
        {
            ...
            Assert.Equal("🦒", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f992.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_Unicode11Test()
        {
            ...
            Assert.Equal(new[] { 0, 1 }, entity.Indices);
            Assert.Equal("🦸", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f9b8.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_Unicode12Test()
        {
            ...
            Assert.Equal(new[] { 0, 1 }, entity.Indices);
            Assert.Equal("🧅", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f9c5.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_Unicode13Test()
        {
            ...
            Assert.Equal(new[] { 0, 1 }, entity.Indices);
            Assert.Equal("🥷", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f977.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_Unicode14Test()
        {
            ...
            Assert.Equal(new[] { 0, 1 }, entity.Indices);
            Assert.Equal("🫠", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1fae0.png", entity.Url);
        }

        [Fact]
        public void ExtractEmojiEntities_Unicode15_1Test()
        {
            // Unicode 15.1 で追加された絵文字
            var origText = "🐦\u200D🔥"; // U+1F426 U+200D U+1F525 (PHOENIX)
            var entity = TweetExtractor.ExtractEmojiEntities(origText).Single();

            Assert.Equal(new[] { 0, 3 }, entity.Indices);
            Assert.Equal("🐦\u200D🔥", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f426-200d-1f525.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_EmojiModifiers_CombiningTest()
        {
            ...
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f466-1f3ff.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_EmojiModifiers_SingleTest()
        {
            ...
            Assert.Equal(new[] { 0, 1 }, entity.Indices);
            Assert.Equal("\U0001F3FF", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f3ff.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_EmojiZWJSequenceTest()
        {
            ...
            Assert.Equal(new[] { 0, 3 }, entity.Indices);
            Assert.Equal("👨\u200D🎨", entity.Text);
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f468-200d-1f3a8.png", entity.Url);
        }
        ...
        public void ExtractEmojiEntities_EmojiZWJSequenceWithVariationSelectorTest()
        {
            ...
            Assert.Equal("https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/1f3c3-200d-2640-fe0f.png", entity.Url);
        }
    }
}

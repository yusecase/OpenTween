...
{
    public class MobypictureTest
    {
        [Fact]
        public async Task UploadAsync_Test()
        {
            var mockApi = new Mock<IMobypictureApi>();
            var mobypictureApi = mockApi.Object;

            var mobypicture = new Mobypicture(mobypictureApi, TwitterConfiguration.DefaultConfiguration());
